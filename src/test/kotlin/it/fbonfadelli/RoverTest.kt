...
* */
    ...
    inner class TurnRight {
        ...
        internal fun `turn right - from north`() {
            ...
            assertThat(position).isEqualTo(State(Position(1, 0), Direction.East))
        }
        ...
        internal fun `turn right - from east`() {
            ...
            assertThat(position).isEqualTo(State(Position(1, 0), Direction.South))
        }
        ...
        internal fun `turn right - from south`() {
            ...
            assertThat(position).isEqualTo(State(Position(1, 0), Direction.West))
        }
        ...
        internal fun `turn right - from west`() {
            ...
            assertThat(position).isEqualTo(State(Position(1, 0), Direction.North))
        }
    }
    ...
    inner class MoveForward {
        ...
        internal fun `move forward - from south`() {
            ...
            assertThat(position).isEqualTo(State(Position(0, -1), Direction.South))
        }
        ...
        internal fun `move forward - from north`() {
            ...
            assertThat(position).isEqualTo(State(Position(0, 1), Direction.North))
        }
    }
